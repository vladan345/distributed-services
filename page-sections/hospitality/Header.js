...
export default function Header() {
  return (
    <header className="fixed left-0 top-0 z-[999] h-[90px] w-full bg-white py-[20px] md:h-[60px]">
      <div className="hosp-container flex items-center justify-between">
        ...
        <button className="hosp-h4 rounded-full bg-accent px-[26px] py-[16px] xl:hidden">
          Book a meeting
        </button>
      </div>
    </header>
