...
function Rikas() {
  ...
  useEffect(() => {
    const imgSize = [window.innerWidth, main.current.offsetHeight];
			...
			`;
    {
      ...
      function resize() {
        ...
        if (main.current.offsetHeight / window.innerWidth < imageAspect) {
          a1 = 1;
          a2 = main.current.offsetHeight / window.innerWidth / imageAspect;
        } else {
          a1 = (window.innerWidth / main.current.offsetHeight) * imageAspect;
          a2 = 1;
        }
        ...
        renderer.setSize(window.innerWidth, main.current.offsetHeight);
        aspect = window.innerWidth / main.current.offsetHeight;
      }
