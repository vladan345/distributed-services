  ...
  return (
    <section className={styles.Laptop}>
      <div className="container">
        ...
        <div className={styles.textRow}>
          ...
          <p>
            ...
            today&apos;s dynamic online ecosystem, our team undertook a
            comprehensive approach to ensure optimal user experience across
            various devices. Klei Works is now available for desktop, tablet and
            mobile.
          </p>
        </div>
      </div>
      ...
      <div className={styles.background}>
        <Image
          src="/images/single-project/klei/laptop_bg.webp"
          alt="Background laptop"
          fill
          className={styles.laptopBg}
        />
        <Image
          src="/images/single-project/klei/laptop.webp"
          alt="Laptop"
          width={1279}
          height={1007}
        ...
        <video playsInline autoPlay muted loop className={styles.video}>
          <source
            src="/images/single-project/klei/laptop-video.mp4"
            type="video/mp4"
          />
        </video>
      </div>
